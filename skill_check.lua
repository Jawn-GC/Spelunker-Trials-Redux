local skill_check = {
    identifier = "skill_check",
    title = "Skill Check [Vol. 1]",
    theme = THEME.DWELLING,
    world = 1,
	level = 1,
	width = 4,
    height = 4,
    file_name = "skill_check.lvl",
}
...
skill_check.load_level = function()
	...
	toast(skill_check.title)
	
end

skill_check.unload_level = function()
