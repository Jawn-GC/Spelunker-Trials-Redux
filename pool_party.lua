local pool_party = {
    identifier = "pool_party",
    title = "Pool Party [C-Sides]",
    theme = THEME.JUNGLE,
	world = 4,
	level = 6,
    width = 4,
    height = 6,
    file_name = "pool_party.lvl",
}
...
pool_party.load_level = function()
	...
	toast(pool_party.title)
end

pool_party.unload_level = function()
