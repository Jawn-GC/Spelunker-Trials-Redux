local effervescence = {
    identifier = "effervescence",
    title = "Effervescence [Vol. 2]",
    theme = THEME.TIDE_POOL,
	world = 2,
	level = 8,
    width = 5,
    height = 4,
    file_name = "effervescence.lvl",
}
...
effervescence.load_level = function()
	...
	toast(effervescence.title)
end

effervescence.unload_level = function()
