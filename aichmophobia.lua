local aichmophobia = {
    identifier = "aichmophobia",
    title = "Aichmophobia [Vol. 1]",
    theme = THEME.JUNGLE,
    world = 1,
	level = 8,
	width = 4,
    height = 4,
    file_name = "aichmophobia.lvl",
}
...
aichmophobia.load_level = function()
	...
	toast(aichmophobia.title)
	
end

aichmophobia.unload_level = function()
