local bounce_house = {
    identifier = "bounce_house",
    title = "Bounce House [Vol. 1]",
    theme = THEME.NEO_BABYLON,
    world = 1,
	level = 14,
    width = 5,
    height = 4,
    file_name = "bounce_house.lvl",
}
...
bounce_house.load_level = function()
	...
	toast(bounce_house.title)
end

bounce_house.unload_level = function()
