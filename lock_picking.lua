local lock_picking = {
    identifier = "lock_picking",
    title = "Lock Picking [Vol. 1]",
    theme = THEME.DWELLING,
    world = 1,
	level = 2,
    width = 4,
    height = 3,
    file_name = "lock_picking.lvl",
}
...
lock_picking.load_level = function()
	...
	toast(lock_picking.title)
	
end

lock_picking.unload_level = function()
